...
require_once(dirname(__FILE__).'/../../drivers/adodb-mysql.inc.php');

class KT_ADODB_mysql extends ADODB_mysql {
	...
	*/
	class KT_ADORecordSet_mysql extends ADORecordSet_mysql {
		var $exfields = false;
		...
		*/
		...
		/*
			...
			@return
				boolean true if the field has changed from the previous value, false otherwise
		*/
		function FieldHasChanged($field){
			if (isset($this->exfields)) {
